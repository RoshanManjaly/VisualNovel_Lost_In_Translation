...
label start:
    ...
    mom "You decided to spend your prime in Tokyo and you're telling me that you can't find any halfway decent eligible bachelors?"
    ...
    mom "Your father and I are only getting older. We only have so many years left to see our grandchildren before we make our exit."
    ...
    mom "Yuuki-chan, are you listening? Tell your parents they won't die before seeing their grandchildren."
...
label not_lie:
    ...
    mom "Then find a boyfriend sooner rather than later!"
...
label werent_listening:
    ...
    mom "What're we going to do with you? Your parents are going to die of a broken heart."
...
label end_of_call:
    ...
    mom "We're always missing you around. Love you!"
